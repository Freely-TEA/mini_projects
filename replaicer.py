# Вумчик, дорогой, хз как, но простовызываешь
# функцию replaicer() и в скобках должен быть текст
# это может быть переменная
# возврат будет в виде текста
# дальше сам)
# я не шарю
def replaicer(text):
    text = str(text)
    raplaice_dic = {"`":"ё", "~":"Ё", "q":"й", "Q":"Й", "w":"ц", "W":"Ц", "e":"у", "E":"У", "r":"к", "R":"К",
    ...
    translated_text = str()
    for i in text:
        translated_text += raplaice_dic.get(i)
